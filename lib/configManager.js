...
class ConfigManager {
  ...
  getFullscreenSetting() {
    ...
    return typeof fullscreenEnabled === "boolean"
      ? fullscreenEnabled
      : defaultFullscreen;
  }
  ...
  getConfettiEffect() {
    return this.getSetting("confettiEffect", "shootDefault");
  }

  setConfettiEffect(effect) {
    this.setSetting("confettiEffect", effect);
  }
}
